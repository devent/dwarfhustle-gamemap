...
import com.anrisoftware.dwarfhustle.gui.javafx.actor.PropertiesPanelActor;
...
/**
 * Object properties pane tab.
 *
 * @author Erwin Müller, {@code <erwin@muellerpublic.de>}
 */
@Data
@Slf4j
public class PropertiesPaneTab implements ObjectPaneTab {
    ...
    public void create(Injector injector, TabPane tabPane) {
        PropertiesPanelActor.create(injector, ofSeconds(1)).whenComplete((res, ex) -> {
            if (ex == null) {
                ...
                log.error("PropertiesPanelActor", ex);
            }
