...
public class DebugConsoleLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
				...
				"T__23", "TILES", "MARK", "CAMERA", "HERE", "INT", "FLOAT", "DIGIT", "STRING", "ID", "ID_CHARS",
			"WS"
		};
	}
	...
	public DebugConsoleLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "DebugConsole.g4"; }
