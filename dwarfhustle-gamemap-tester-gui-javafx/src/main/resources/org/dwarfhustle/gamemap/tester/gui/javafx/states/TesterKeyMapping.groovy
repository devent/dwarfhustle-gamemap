...
m.YELLOWSAND_MATERIAL_MAPPING = [message: new MaterialSetTriggeredMessage("sand", "yellowSand"), code: empty(), trigger: empty()]
m.WHITESAND_MATERIAL_MAPPING = [message: new MaterialSetTriggeredMessage("sand", "whiteSand"), code: empty(), trigger: empty()]
m.REDSAND_MATERIAL_MAPPING = [message: new MaterialSetTriggeredMessage("sand", "redSand"), code: empty(), trigger: empty()]
m.BLACKSAND_MATERIAL_MAPPING = [message: new MaterialSetTriggeredMessage("sand", "blackSand"), code: empty(), trigger: empty()]
